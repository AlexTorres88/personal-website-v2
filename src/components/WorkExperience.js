    ...
    return (
        <div className="work-exp-container">
            <div className="work-exp-item">   
                ...
                <InfoIconModal title="Konfio" body="Currently working with React, Typescript and Flask. I create new features, refactor code and fix bugs on the account creation team." img={Konfio}/>
            </div>
            ...
            <div className="work-exp-item">   
                ...
                <InfoIconModal title="Kinedu" body="Worked with Ruby on Rails on the backend team developing new features for the main REST API which served a web and mobile application." img={Kinedu}/>
            </div>
            <CircleOutlinedIcon className="circle"/>
            <div>
